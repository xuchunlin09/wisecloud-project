...
- [ ] 1. 搭建 Spring Boot 后端项目脚手架与基础配置
  - [ ] 1.1 初始化 Spring Boot 项目结构与 Maven 依赖
...
- [ ] 2. 实现 JWT 认证与用户注册登录
  ...
  - [ ] 2.2 实现 AuthService 与 AuthController
...
- [ ] 4. 实现 WiseCloudService — SDK 调用统一封装
  - [ ] 4.1 实现 WiseCloudService 核心方法
...
- [ ] 5. 实现设备管理功能（导入、概览、搜索、详情）
  - [ ] 5.1 实现 DeviceService 业务逻辑
  ...
  - [ ] 5.2 实现 DeviceController REST 接口
...
- [ ] 7. 实现应用管理与任务下发功能
  - [ ] 7.1 实现 ApplicationService 与 ApplicationController
  ...
  - [ ] 7.2 实现 TaskService 与 TaskController
...
- [ ] 9. 搭建 Android 客户端项目脚手架与网络层
  - [ ] 9.1 初始化 Android 项目结构与依赖配置
...
- [ ] 10. 实现 Android 登录注册页面
  - [ ] 10.1 实现登录与注册 UI 及 ViewModel
...
- [ ] 16. 容器化部署配置（可选）
  - [ ] 16.1 创建 Docker 与 Kubernetes 部署文件
